...
type SitePageContext = {
  ...
  readonly nodes: Maybe<ReadonlyArray<Maybe<SitePageContextNodes>>>;
};

type SitePageContextNodes = {
  readonly id: Maybe<Scalars['String']>;
  readonly frontmatter: Maybe<SitePageContextNodesFrontmatter>;
  readonly excerpt: Maybe<Scalars['String']>;
};

type SitePageContextNodesFrontmatter = {
  readonly title: Maybe<Scalars['String']>;
...
type MarkdownRemarkFrontmatter_last_modified_atArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type SitePageContextFilterInput = {
  ...
  readonly categories: Maybe<StringQueryOperatorInput>;
  readonly nodes: Maybe<SitePageContextNodesFilterListInput>;
};

type SitePageContextNodesFilterListInput = {
  readonly elemMatch: Maybe<SitePageContextNodesFilterInput>;
};

type SitePageContextNodesFilterInput = {
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly frontmatter: Maybe<SitePageContextNodesFrontmatterFilterInput>;
  readonly excerpt: Maybe<StringQueryOperatorInput>;
};

type SitePageContextNodesFrontmatterFilterInput = {
  readonly title: Maybe<StringQueryOperatorInput>;
  readonly categories: Maybe<StringQueryOperatorInput>;
  readonly path: Maybe<StringQueryOperatorInput>;
  readonly last_modified_at: Maybe<DateQueryOperatorInput>;
...
type SitePageFieldsEnum =
  ...
  | 'context.nodes'
  | 'context.nodes.id'
  | 'context.nodes.frontmatter.title'
  | 'context.nodes.frontmatter.categories'
  | 'context.nodes.frontmatter.path'
  | 'context.nodes.frontmatter.last_modified_at'
  | 'context.nodes.excerpt'
  | 'pluginCreator.id'
  ...
  | 'pluginCreator.pluginOptions.dest'
...
type Unnamed_1_Query = { readonly allMarkdownRemark: (
